...
- px-compare-create-diffs     :\tRun this after you have made your changes and want to\
...
- px-compare-create-changed   :\tCompare the control folder 'screenshots' against a given other folder (supplied with the '<compare-folder>') argument,\
 e.g. px-compare-create-changed --compare-folder="screenshot-10:12:30".
